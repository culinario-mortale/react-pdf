...
```sh
yarn add @culinario-mortale/react-pdf-render
```

## How it works

```js
import render from "@culinario-mortale/react-pdf-render";
import primitives from "@culinario-mortale/react-pdf-primitives";
...
imported from `@culinario-mortale/react-pdf-primitives`
...
import fs from "fs";
import render from "@culinario-mortale/react-pdf-render";
import pdfkit from "@culinario-mortale/react-pdf-pdfkit";
